function fillDataToys(){
 ...
 function resetTable() {
     var table = document.getElementById('table');
     var codeBlock = '<table class="table table-striped" style=" margin-top: 10px; background-color: whitesmoke;" id="table">' + '<tr>' + '<th>Kid ID</th>' + '<th>First Name</th>' + '<th>Available</th>' + '<th>Wishlist Length</th>' + '</tr>' + '</table>';
